...
def get_size(journalists)
  puts journalists.count
end

def get_numbers(journalists)
  puts journalists.grep(/\d/).count
end

def get_aude(journalists)
  puts journalists.map {|handle| handle.downcase}.grep(/aude/).count
end

def get_maj_at_start(journalists)
  puts journalists.grep(/^@[A-Z]/).count
end

def get_maj(journalists)
  puts journalists.grep(/[A-Z]/).count
end

def get_underscore(journalists)
  puts (journalists.map {|str| str.count("_") }).sum
end

def sort(journalists)
  puts journalists.sort(&:casecmp)
end

def fifty_shortest(journalists)
  puts (journalists.sort_by(&:length))[0..49]
end

def get_epenser(journalists)
  puts journalists.index("@epenser")
end

def perform
  journalists = init
  get_size(journalists)
  get_numbers(journalists)
  get_aude(journalists)
  get_maj_at_start(journalists)
  get_maj(journalists)
  get_underscore(journalists)
  #sort(journalists)
  #fifty_shortest(journalists)
  get_epenser(journalists)
end
